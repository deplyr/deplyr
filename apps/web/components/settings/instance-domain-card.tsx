      ...
      <div className="min-w-0 text-sm leading-relaxed">
        {state === "waiting_dns" ? (
          ...
          <>
            ...
            <p className="mt-1 text-muted">
              This normally takes under a minute. If it's still here after 5 minutes, check that ports <span className="font-mono text-foreground">80</span> and{" "}
              <span className="font-mono text-foreground">443</span> are open to the internet in your server's firewall or cloud security group — the
              certificate can't be issued without them.
            </p>
          </>
        )}
      </div>
