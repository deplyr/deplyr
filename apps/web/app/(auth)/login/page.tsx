...
const inputClass =
  "w-full rounded-xl border border-white/10 bg-white/[0.04] py-2.5 pl-10 pr-3 text-sm text-foreground placeholder:text-muted/70 transition focus:border-accent/60 focus:bg-white/[0.06] focus:outline-none focus:ring-4 focus:ring-accent/10 [&:-webkit-autofill]:[-webkit-text-fill-color:#F4F4F5] [&:-webkit-autofill]:shadow-[inset_0_0_0_1000px_#15151a]";
...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-md rounded-3xl bg-gradient-to-b from-white/20 to-white/[0.03] p-px shadow-2xl shadow-black/50">
      <div className="rounded-[calc(1.5rem-1px)] bg-[#0c0c10]/90 p-8 backdrop-blur-xl sm:p-10">
        ...
        <a
          ...
          className="mt-7 flex w-full items-center justify-center gap-2.5 rounded-xl bg-white px-4 py-2.5 text-sm font-medium text-black shadow-sm transition hover:bg-white/90 active:scale-[0.99]"
        >
