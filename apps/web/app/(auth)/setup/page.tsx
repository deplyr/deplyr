...
const inputClass =
  "w-full rounded-xl border border-white/10 bg-white/[0.04] py-2.5 pl-10 pr-3 text-sm text-foreground placeholder:text-muted/70 transition focus:border-accent/60 focus:bg-white/[0.06] focus:outline-none focus:ring-4 focus:ring-accent/10";
    ...
    <div className="w-full max-w-md rounded-3xl bg-gradient-to-b from-white/20 to-white/[0.03] p-px shadow-2xl shadow-black/50">
      <div className="rounded-[calc(1.5rem-1px)] bg-[#0c0c10]/90 p-8 backdrop-blur-xl sm:p-10">
        ...
        <div className="mt-3 flex gap-1.5">
          ...
          <div className={`h-1 flex-1 rounded-full ${step === 2 ? "bg-accent" : "bg-white/10"}`} />
        </div>
